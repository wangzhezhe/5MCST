...
//============================================================================
// This code comes from original vktm repo, we added some print log for testing
#ifndef vtk_m_filter_flow_internal_TEST_BoundsMap_h
#define vtk_m_filter_flow_internal_TEST_BoundsMap_h
        ...
        private:
          ...
          void Init(const std::vector<vtkm::cont::DataSet> &dataSets)
          {
            ...
            for (const auto &i : ids)
            {
              ...
              std::cout << "rank " << Comm.rank() << " add local block id " << i << std::endl;
            }
...
#endif // vtk_m_filter_flow_internal_TEST_BoundsMap_h
